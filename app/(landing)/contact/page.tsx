            ...
            <Card className="overflow-hidden border-sage-200 dark:border-sage-800 bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm">
              <CardContent className="p-6">
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="mt-1 bg-sage-100 dark:bg-sage-900/50 p-2 rounded-full">
                      <Phone className="h-5 w-5 text-[--neutral]" />
                    </div>
                    <div>
                      <h3 className="font-medium text-[--neutral]">Phone</h3>
                      <p className="text-[--neutral] mt-1">+ (380) 88 88 88 888</p>
                    </div>
                  </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="bg-white/70 dark:bg-gray-800/70 border-sage-200 dark:border-sage-800 focus:border-sage-500 focus:ring-sage-500 text-gray-600 dark:text-gray-300"
                    required
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="message" className="text-[--neutral]">
                    Message
                  </Label>
                  <Textarea
                    id="message"
                    ...
                    className="min-h-[150px] bg-white/70 dark:bg-gray-800/70 border-sage-200 dark:border-sage-800 focus:border-sage-500 focus:ring-sage-500 text-gray-600 dark:text-gray-300"
                    required
                  />
                </div>
                  ...
                  {isSubmitting ? (
                    <Button disabled size="sm" className="w-full sm:w-auto">
                      <span className="flex items-center gap-2">
                        <svg
                          className="animate-spin -ml-1 mr-2 h-4 w-4 text-[--neutral]"
