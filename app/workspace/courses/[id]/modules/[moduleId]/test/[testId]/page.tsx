...
import {TestQuestion, UserTestAnswer} from "@/lib/definitions";
    ...
    return (
        <Card className="max-w-2xl mx-auto mt-8">
                ...
                <CardContent>
                    <div className="space-y-6">
                        ...
                        <RadioGroup
                            ...
                            className="space-y-3"
                        >
                            {questions[currentQuestionIndex].answers.sort((a, b) => a.id - b.id).map((answer) => (
                                <div key={answer.id}
            ...
            <CardFooter className="flex justify-center">
                <Button onClick={handleNext} disabled={selectedAnswer === null} className="w-full max-w-xs">
                    Next question
                </Button>
            </CardFooter>
        </Card>
