...
// async function getWeeklyStreakData(userId: string) {
//   return {
//     points: 20,
//     weeks: 1,
...
// export default async function Page() {
//   const [topUsers, createdCourses, coursesInProgress, fetchedCoursesWithProgress] = await Promise.all([
//     getTopUsersByPoints(0, 10),
//     getUserCreatedCourses(0, 50),
//     getUserCourses(0, 50),
//     getCoursesWithUserProgress(0, 50),
//   ]);
...
//     try {
//       const spacedRepetition = course.user_progress?.[0]?.spaced_repetition;
//       if (!spacedRepetition || !Array.isArray(spacedRepetition.next_review_dates)) {
//         return false;
//       }
//       return spacedRepetition.next_review_dates.includes(today);
//     } catch (error) {
//       console.error(`Error filtering course ${course.id} for repeat:`, error);
//       return false;
//     }
//   });
...
//   const streakData = await getWeeklyStreakData(userId);
//   const weeklyStreak = {
//     ...streakData,
//     dateRange,
//   };
...
//   const endOfWeek = new Date(startOfWeek);
//   endOfWeek.setDate(endOfWeek.getDate() + 6);
//   const dateRange = `${startOfWeek.toISOString().split("T")[0]} - ${endOfWeek.toISOString().split("T")[0]}`;
//   const weeklyStreak = {
//     points: 20,
//     weeks: 1,
//     courseMinutes: { completed: 22, total: 30 },
