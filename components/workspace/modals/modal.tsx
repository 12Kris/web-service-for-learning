...
type ModalProps = {
  isOpen: boolean
  onClose: () => void
//   onSave: (data: { title?: string; front?: string; back?: string; question?: string; answers?: any[] }) => void
...
//     //     correct: boolean | number;
//     // }[];
//     // { id: string | number; question: string; answers: { id: string; text: string; correct: number | boolean; }
// }[]
}) => void
  type: "question" | "card"
  initialData?: (CardType & QuestionType) | null
